...
import { Shield, Menu, X, User, LogOut, LayoutDashboard, Home, ChevronDown, Zap, Lock, Eye, Fingerprint } from 'lucide-react';
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            {user ? (
              <div className="flex items-center space-x-4">
                <Button variant="ghost" size="sm" onClick={onLogin} className="text-slate-300 hover:text-white hover:bg-slate-800/50">
              ...
              <div className="flex items-center space-x-3">
                ...
                <Button onClick={onLogin} className="bg-transparent border border-slate-300/30 text-slate-300 hover:text-white hover:border-white/50 hover:bg-white/5 transition-all duration-200">
            ...
            <div className="flex flex-col space-y-4">
              ...
              {user ? (
                <div className="pt-4 border-t border-slate-800/50">
                  <div className="flex flex-col space-y-4">
                    <Button variant="ghost" size="sm" onClick={onLogin} className="w-full justify-start text-slate-300 hover:text-white hover:bg-slate-800/50">
                      <LayoutDashboard size={16} className="mr-2" />
                      Dashboard
                    </Button>
                ...
                <div className="pt-4 border-t border-slate-800/50">
                  <Button onClick={onLogin} className="w-full bg-transparent border border-slate-300/30 text-slate-300 hover:text-white hover:border-white/50 hover:bg-white/5 transition-all duration-200">
                    <User size={16} className="mr-2" />
                    Login
                  </Button>
                </div>
